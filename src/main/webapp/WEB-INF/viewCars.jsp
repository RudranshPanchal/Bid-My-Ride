...
<section class=" bg-color cover-bg-opacity text-left pb_gradient_v3 " id="section-home">
  <div class="row">
     <div class="col-md-11 m-5 pt-5">
    <div class="row">
       <div class="col-md-3">
       	<div class="bg-light p-3 rounded"  style=" background-image: linear-gradient(45deg, #79672a, #000000);">
            <h2 class="titular">Search Cars!</h2>
...
<h1 class="text-white">OOPS!!! Data Not Found!!!</h1>
<h2 class="text-white">Try Another Keyword!!!</h2>
</div>
</vc:if>
